...
namespace serverKinect
{
    public partial class MainWindow : Window
    {
        ...
        private byte[] data = new byte[8142];
        ...
        public MainWindow()
        {
            ...
            //kinect
            player1JointsTracked = new bool[20];
            player1JointsPos = new Vector3[20];
            player1JointsOri = new Matrix4x4[20];
        ...
        private void SensorSkeletonFrameReady(object sender, SkeletonFrameReadyEventArgs e)
        {
            ...
            //nastimamo koordinate
            for (int j = 0; j < (int)NuiSkeletonPositionIndex.Count; j++)
            {
                if (skel.Joints[vrniJoint(j)].TrackingState == JointTrackingState.Tracked)
                {
                    
                    player1JointsTracked[j] = true;
                    player1JointsPos[j] = skelToVector(skel.Joints[vrniJoint(j)].Position);
            ...
            obj.pos = skelToVector2(skel.Position);            
        ...
        public JointType vrniJoint(int i)
        {
            switch (i)
            {
                case 0:
        ...
        private Vector3 skelToVector(SkeletonPoint p)
        {
        ...
        private MyVector3 skelToVector2(SkeletonPoint p)
        {
