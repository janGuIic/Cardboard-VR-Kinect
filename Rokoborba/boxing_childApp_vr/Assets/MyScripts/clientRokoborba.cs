...
{
    //posiljanje
    public UdpClient udpServerSend;
    public IPEndPoint remoteEPSend;
    ...
    private void sendForward(byte[] data)
    {
        try
        {
            udpServerSend.Send(data, data.Length);
        }
        catch (Exception e) {
    ...
    void OnApplicationQuit()
    {
        ...
        Debug.Log("Application ending after " + Time.time + " seconds" + this);
    }   
